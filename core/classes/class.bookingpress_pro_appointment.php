...
if ( ! class_exists( 'bookingpress_pro_appointment' ) ) {
	class bookingpress_pro_appointment Extends BookingPress_Core {
		...
		function bookingpress_modify_appointment_data_fields_func( $bookingpress_appointment_vue_data_fields ) {
			...
			$bookingpress_appointment_vue_data_fields['export_checked_field'] = array( 'customer_full_name', 'customer_email_address', 'customer_phone_number', 'staff_member_full_name', 'service', 'amount', 'start_time', 'end_time', 'note', 'appointment_status', 'appointment_created_date' );
