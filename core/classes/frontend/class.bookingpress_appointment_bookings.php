            ...
            bookingpress_phone_country_close_repeater( vmodel ){
				...
				bookingpress_close_extra_drawer_on_mouseup(){
					...
					window.addEventListener( "mouseup", function(e){
						...
						if( parentNode.length < 1 && parentNodeBawy.length < 1 && "true" == vm.bookingpress_open_extras_drawer && "service" == app.bookingpress_current_tab && "true" == vm.bookingpress_open_extras_drawer && true == is_visible ){
