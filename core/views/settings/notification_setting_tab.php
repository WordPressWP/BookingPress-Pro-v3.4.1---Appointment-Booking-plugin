<el-tab-pane class="bpa-tabs--v_ls__tab--pane-body" name ="notification_settings" label="notifications" data-tab_name="notification_settings">
    ...
    <div class="bpa-general-settings-tabs--pb__card bpa-notification-settings-tabs--pb__card">
        ...
        <div class="bpa-gs--tabs-pb__content-body">            
                    ...
                    <el-row type="flex" class="bpa-gs--tabs-pb__cb-item-row" v-if="notification_setting_form.selected_mail_service == 'Google_Gmail'">
                            ...
                            <el-col :xs="12" :sm="12" :md="12" :lg="16" :xl="16" class="bpa-gs__cb-item-right">
                                <div class="bpa-gs__redirect-url-val">
                                    <p><?php echo get_home_url(). '?page=bookingpress_gmailapi'; //phpcs:ignore ?></p>
                                    <span class="material-icons-round" @click="bookingpress_gmail_insert_placeholder('<?php echo get_home_url() .'?page=bookingpress_gmailapi'; //phpcs:ignore ?>','text')">content_copy</span>
                                </div>
                            </el-col>                            
                    </el-row>
                    <el-row type="flex" class="bpa-gs--tabs-pb__cb-item-row" v-if="notification_setting_form.selected_mail_service == 'Google_Gmail'">
            ...
            <?php
            do_action('bookingpress_add_notification_settings_section');			
            ?>  
            </el-form>
        </div>    
    </div>
...
<el-dialog custom-class="bpa-dialog bpa-dialog--smtp-notification-settings" title="" :visible.sync="smtp_error_modal" :visible.sync="centerDialogVisible" close-on-press-escape="close_modal_on_esc" :modal="smtp_error_modal" @open="bookingpress_enable_modal" @close="bookingpress_disable_modal">
