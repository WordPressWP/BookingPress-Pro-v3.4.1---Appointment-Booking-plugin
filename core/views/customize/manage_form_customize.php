                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <el-select v-model="booking_form_settings.bookigpress_time_format_for_booking_form" class="bpa-form-control"  popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                <el-option label="<?php esc_html_e('11:00 to 12:00', 'bookingpress-appointment-booking'); ?>" value="1" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php esc_html_e('11:00 to 12:00', 'bookingpress-appointment-booking');  ?></el-option>
                                                <el-option label="<?php esc_html_e('11:00 am to 12:00 pm', 'bookingpress-appointment-booking'); ?>" value="2" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true" ><?php esc_html_e('11:00 am to 12:00 pm', 'bookingpress-appointment-booking'); ?></el-option>
                                                <el-option label="<?php esc_html_e('11:00 - 12:00', 'bookingpress-appointment-booking'); ?>" value="5" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php esc_html_e('11:00 - 12:00', 'bookingpress-appointment-booking'); ?></el-option>
                                                <el-option label="<?php esc_html_e('11:00 am - 12:00 pm', 'bookingpress-appointment-booking'); ?>" value="6" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php esc_html_e('11:00 am - 12:00 pm', 'bookingpress-appointment-booking'); ?></el-option>
                                                <el-option label="<?php esc_html_e('11:00', 'bookingpress-appointment-booking'); ?>" value="3" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php esc_html_e('11:00', 'bookingpress-appointment-booking'); ?></el-option>
                                                <el-option label="<?php esc_html_e('11:00 am', 'bookingpress-appointment-booking'); ?>" value="4" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php esc_html_e('11:00 am', 'bookingpress-appointment-booking'); ?></el-option>
